...
class Home extends Component {
      ...
      <Content className={'index-content'}>
        ...
        <Row className="content3" type="flex" justify="space-around">
          ...
          <Col className="circle2-middle" xs={24}  sm={24} md={24} lg={24}>
            <h3> It will also provide information
        ...
        <Row className="content4-container" >
          ...
          <Col className="content4" xs={24}  sm={24} md={12} lg={12}>
            <div className="content4-top">
              ...
              <p>
                It will highlight the urgency of low stocks and fake countdowns and remind the user to relax and that, more than likely, the stock and countdown is fake. The dark patterns that fall into this category are:
        ...
        <Row className="content-table">
          <Col className="content-table table">
            <h3 className="table-header">
              The following table will categorise the dark patterns: <br />
              <p><u>Note: The dark patterns in bold writing are the patterns our chrome extension is able to detect for now.</u></p>
            </h3>
          ...
          <div style={{overflow:"scroll", width: '100%'}}>
            <table >
              <tr>
                ...
                <td style={{width: '60%'}}>When you try to purchase something online, the site sneaks and addition items or prices into your basket.
              ...
              <tr>
                ...
                <td style={{width: '60%'}}>When purchasing an item, the site will hide the costs of such things as delivery or tax until you reach the checkout.
                </td>
              </tr>
            </table >
            ...
            <table>
              <tr>
                ...
                <td style={{width: '60%'}}>
                  Invoking language and emotion (shame) to convince users not to make a certain choice or guilting users into opting into something.
                  (e.g., “No thanks, I don’t want to save.”)
                </td>
              </tr>
              <tr>
                <td style={{width: '15%'}}>
            ...
            <tr>
              ...
              <td style={{width: '60%'}}>
                Using a countdown timer to alert users that a discount or deal is about to expire, which only purposely creates urgency for the purchase
                (e.g., “sale ends in 12h20m33s”)
              </td>
            </tr>
            <tr>
              <td style={{width: '15%'}}> <img src="/assets/img/1FakeLimitedTime.png" alt="test." /></td>
              <td style={{width: '60%'}}>  Giving users the impression that a deal or sales only for a limited amount of time or is about to expire soon, without stating a specific deadline.
                (e.g., “sale ends soon”, “only available for a limited time”)
              </td>
            </tr>
              <tr>
                <td style={{width: '15%'}}>  <img src="/assets/img/1FakeHighdemand.png" alt="test." /></td>
                <td style={{width: '60%'}}>
                  Informing users that the product is in high-demand and will sell out soon, thereby making it more attractive to users.
            ...
            <tr>
              ...
              <td style={{width: '60%'}}>
                Informing users about the limited availability of a product, making it more desirable to users. (e.g., “only 2 items left in stock”)
              </td>
            </tr>
          </table>
            <table>
            <tr>
              ...
              <td style={{width: '60%'}}>
                Sharing more information to the public than you originally intended to do.
                (e.g., Messesnger set-up. It claims to ONLY "upload your contacts to connect you with friends", but not until you click the "Learn more" button you find out exactly what information is being used.(This info was used to push ads.))
              </td>
            </tr>
            <tr>
              <td style={{width: '15%'}}>
  ...
  <table>
          ...
          <tr>
            ...
            <td>
            Sharing more information to the public than you orignally intended to do.
