...
class AboutUs extends Component {
  ...
  render() {
    ...
    <div id="header">
      ...
      <div id="bannerbar">
        <h2 style="color:white; text-align: center">Sale Ends in 23h:34m:55s</h2>
      </div>
    </div>
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <br />
        <p>The festive season is full of traditions, both new and old that all add to the Christmas cheer and wonder,
          and traditions such as choosing and decorating a real Christmas tree, can also help make our homes feel a little bit merrier as well.</p>
        ...
        <ul>
          <li><p><img src="/assets/img/tree1.jpg" alt="Christmas Star" width="100" height="100"> >>>>>>>> Only 5 Left <br>
            <a href="https://www.ikea.com/ie/en/stores/events/book/19661/">A Christmas tree that comes with a gift</a></p></li>
        </ul>
        ...
        <ul>
          <li><img src="/assets/img/star1.jpg" alt="Christmas Star" width="100" height="100"><br>
            <a href="https://www.ikea.com/ie/en/p/strala-lamp-shade-leaf-gold-colour-dot-pattern-10503595/">Lamp Shade, 70cm</a></li><br>
          <li><p><img src="/assets/img/star2.jpg" alt="Christmas Star" width="100" height="100"> >>>>>>>> This item is selling fast<br>
            <a href="https://www.ikea.com/ie/en/p/strala-lamp-shade-leaf-gold-colour-dot-pattern-80503728/">Lamp Shade, 90cm</a></li></p>
          <li><img src="/assets/img/star3.jpg" alt="Christmas Star" width="100" height="100"><br>
            <a href="https://www.ikea.com/ie/en/p/strala-lamp-shade-leaf-green-20503731/">Lamp Shade, 48cm</a></li><br>
        </ul>
      </div>
    </div>
